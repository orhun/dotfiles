  ...
  opts = {
    ...
    mappings = {
      n = {
        ...
        ["<C-m>"] = { ":ToggleTerm size=30 direction=horizontal<cr>", desc = "Toggle terminal" },
        ...
        ["<C-j>"] = { function() require("telescope.builtin").find_files() end, desc = "Find files" },
      ...
      t = {
        ["<C-m>"] = { "<C-\\><C-N>", desc = "Switch to normal mode" },
      },
    },
  },
}
